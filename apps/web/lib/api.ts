...
const rankingItem = z.object({ ticker: z.string(), name: z.string().optional(), sector: z.string().optional(), market: z.string(), close: z.number().optional(), mispricingScore: z.number(), components: z.unknown().optional(), anomalyFlag: z.boolean().optional(), anomalyZ: z.number().nullable().optional(), rank: z.number().nullable().optional() });
